...
@section('conteudo')
    <div class="container mt-4">
        ...
        <form id="formDeleteSelecionados" action="{{ route('eventos.deleteSelecionados') }}" method="POST">

            @csrf
            @method('DELETE')

            <button type="submit" id="btnExcluirSelecionados" class="btn btn-danger mb-2"
